...
var famousQuote = "\"Try to gain knowledge about everything to the maximum possible of your strength.\"";
console.log("Imam Hazrat Ali Sying :", famousQuote);
//Famous Quote 2: Repeat Exercise 4, but this time store the famous person’s name in a variable called famous_person. Then compose your message and store it in a new variable called message. Print your message.
var personName2 = "Albert Einstien";
...
var strpName = "\tHamad\n\tAli\n";
console.log("name with whit space: ".concat(strpName));
...
var numb = 786;
var sms = "its my favourite number";
...
var friendNames = ["Sheraaz", "Sohail", "Syed safeer Naqvi", "Syed Hassan", "Malik Hanan"];
...
var frindNames = ["Sheraaz", "Sohail", "Syed safeer Naqvi", "Syed Hassan", "Malik Hanan"];
console.log(friendNames);
for (var i = 0; i < frindNames.length; i++) {
    console.log(frindNames[i], "Hello Who Are you");
}
;
//Q no 13
//Your Own Array: Think of your favorite mode of transportation, such as a motorcycle or a car, and make a list that stores several examples. Use your list to print a series of statements about these items, such as “I would like to own a Honda motorcycle.”
var cars = ["toyota corolla", "honda city", "hondai"];
...
var people = ["ahad mir", "faizan ahmad", "muzamall"];
...
console.log("".concat(people[2], "is not available"));
...
var places = ["Makka", "madina", "nNw york", "Haungkaung", "Islamabad"];
console.log(places);
...
var reverseOrder = __spreadArray([], places, true).reverse();
...
var guestNames = ["adnan", "muzamil", "hassan", "ahad"];
...
var locatione = ["k-2", "europ", "Naran Kaghan"];
...
var arrarList = ["computer", "Laptop", "Mobile", "VCR", "Digital Watch"];
console.log(" false index is ".concat(arrarList[7]));
console.log(" true index is ".concat(arrarList[1]));
...
Alien_color.filter(function (clor) {
    if (clor == "red") {
...
var fruits_array = ["apple", "orange", "bannana", "mango",];
...
var usernames = ["awaise", "shan", "hamza", "asad", "usama"];
